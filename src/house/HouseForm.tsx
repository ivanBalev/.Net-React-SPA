...
// We should never use props as state for our components
// Instead, copy the prop we need and create state with the copy
// In this case, house is a reference type and changing its value,
// Will create issues along the chain which uses its value
// The spread syntax into a new object creates a copy of that object
...
return (
    <form className="mt-2">
      ...
      <div className="mt-2">
        {houseState.photo && <img src={houseState.photo} alt="House"></img>}
      </div>
      <button
